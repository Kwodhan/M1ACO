...
public class TestEnregistrement {
	...
	/*
	 * Teste qu'on n'enregistre pas le charment d'un fichier
	 * xs#
	 * xs#a
	 * xsaaaaaa#
	 */
	...
	public void test7Macro() {
		...
		assertEquals("on oublie des choses ?",28+6, this.ihm.toString().length());
	 ...
	 */
	@Test
	public void test8Macro() {
		int length = this.ihm.toString().length();
		this.ihm.pressDebut();
		this.ihm.pressSelection(10, 18);
	...
	@Test
	public void test9Macro() {
		int length = this.ihm.toString().length();
		this.ihm.pressDebut();
		this.ihm.pressSelection(0, length);
		this.ihm.pressCopier();
		this.ihm.pressSelection(0, 0);
		this.ihm.pressColler();
		this.ihm.pressStop();
		...
		assertEquals("on oublie des choses ?",length*(1+1+12), this.ihm.toString().length());
